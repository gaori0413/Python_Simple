...
#   -paremeter값 2개 이상 사용시 정의 된 순서대로 전달해야함
...
#   -return만 사용하면 함수호출문으로 None 값 전달
...
#   -반대로 가장 산단에 정의되어 프로그램 종료 전까지 유지되는 변수를 전역변수
