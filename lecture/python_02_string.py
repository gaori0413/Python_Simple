...
#   - 여러분들이 아이디어가 떠올랐을 때 바로 구현은 못하지만 구글링해서 어떻게하면 만들 수 있겠네라는 생각이 들 정도
...
#id = "      Python1004      "
#id.lower()  "          python1004             "
print(id.lower().strip())      #"python1004"

# 4-6. find() and rfind() : 문자열 내부의 특정 문자 위치 인덱스 출력
print(str.find("o"))    # Hell^o^ World 앞에서 부터
print(str.rfind("o"))   # Hello W^o^rld 뒤에서 부터
